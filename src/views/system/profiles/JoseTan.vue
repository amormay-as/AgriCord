              ...
              <v-card class="pa-4">
                ...
                <v-card-text>
                  <div class="text-center">
                    <p><strong>Barangay:</strong> MAUG</p>
                    <p><strong>Experience:</strong> 4 years in vegetable farming</p>
                    <p><strong>Specialty:</strong> Organic crops</p>
                    <p><strong>Contact:</strong> 0922-xxx-xxxx</p>
                  </div>
                </v-card-text>
                <v-divider></v-divider>
                <v-btn
...
import farmerImage from '@/assets/img/farmer5.png'
