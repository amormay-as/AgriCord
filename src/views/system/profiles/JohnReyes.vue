              ...
              <v-card class="pa-4">
                ...
                <v-card-text>
                  <div class="text-center">
                    <p><strong>Barangay:</strong> PATIN-AY</p>
                    <p><strong>Experience:</strong> 3 years of vegetable farming</p>
                    <p><strong>Specialty:</strong> Organic vegetables</p>
                    <p><strong>Contact:</strong> 0920-xxxx-xxxx</p>
                  </div>
                </v-card-text>
                <v-divider></v-divider>
                <v-btn
...
import farmerImage from '@/assets/img/farmer4.png'
